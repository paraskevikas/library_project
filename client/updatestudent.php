        ...
        <div class="main-content2">
                    <?php
                            ...
                            echo '<div class="form-group col-sm-3 mb-3">';
                                echo '<label class = "form-label"> <p>Change password for user: <br><b>' . $row[0] . ' ' . $row[1] . '</b></p></label>';
                        ...
                        <button class="button" class = "btn btn-primary btn-submit-custom" formaction="student.php">Back</button>
