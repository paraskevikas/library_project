...
<br/>
        ...
        <form class="form-horizontal" name="student-form" method="POST">
                    ...
                    <?php
                            ...
                            $query = "SELECT borrow_id, card_id, ISBN, b_date, r_date, returned FROM borrows WHERE borrow_id = $borrow_id";
                            $res1 = mysqli_query($conn, $query);
                            $row = mysqli_fetch_row($res1);
            
                            echo '<div class="form-group col-sm-3 mb-3">';
                                echo '<label class = "form-label"> <p>Are you sure you want to delete borrowing: <br><b>' . $row[0] . '?</b></p></label>';
