       ...
       <body>
        ...
        <a class="navbar-brand" href="home.php">
           ...
           <div class="main-content2">
               <div class='text'>
                <a href="user1.php">3.3.1 Όλα τα βιβλία που έχουν καταχωριστεί (Κριτήρια αναζήτησης: τίτλος/ κατηγορία/ συγγραφέας), δυνατότητα επιλογής βιβλίου και δημιουργία αιτήματος κράτησης.</a></div>
               <div class='text'>
                <a href="user2.php">3.3.2 Λίστα όλων των βιβλίων που έχει δανειστεί ο συγκεκριμένος χρήστης.</a></div>
                                    ...
                                    while($row = mysqli_fetch_row($result)){
                                        echo '<tr>';
                                            ...
                                            echo '<td>';
                                                ...
                                                echo '<a type="button" class="button" href="./updateteach.php?card_id=' . $row[0]. '">';
