    ...
    <div class="main-content2">
        <div class="text" style="text-align: center;">
            ...
            try {
                        $query = "UPDATE reservations
                        SET stat = 'cancelled'
                        WHERE card_id = '$card_id' AND ISBN = '$ISBN' AND stat <> 'cancelled'";

                        if (mysqli_query($conn, $query)) {
                            echo "Record updated successfully";
                            header("Location: user_reservations.php");
                        } else {
                            echo "Error while updateing record: <br>" . mysqli_error($conn) . "<br>";
                        }
            } catch (exception $e) {
                echo '<p>' . $e->getMessage() . '</p>';
            }
            ...
            <br /><br /><br /><br /><br /><br /><br />
            <a href="user_reservations.php" class="button button3">Back</a>
