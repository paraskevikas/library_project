...
<body>
    ...
    <div class="main-content2">
        ...
        <form class="form-horizontal" name="student-form" method="POST">
            ...
            $query = "SELECT first_name, last_name FROM administrators WHERE admin_id = $admin_id";
            $res1 = mysqli_query($conn, $query);
            $row = mysqli_fetch_row($res1);

            echo '<div class="form-group col-sm-3 mb-3">';
            echo '<label class = "form-label"> <p>Are you sure you want to delete administrator: <br><b>' . $row[0] . ' ' . $row[1] . '?</b></p></label>';
