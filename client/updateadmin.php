...
<body>
    ...
    <div class="main-content2">
        <form class="form-horizontal" name="form" method="POST">
            ...
            <input type="text" , placeholder="Enter Administrator's First Name" , name="first_name">

            <label class="form-label">
                <p> Last Name </p>
            </label>
            <input type="text" , placeholder="Enter Administrator's Last Name" , name="last_name">
